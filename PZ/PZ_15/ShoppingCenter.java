...
public class ShoppingCenter extends building implements SocialHouse {
    ...
    ShoppingCenter(String name, String adress, int year_to_create, String name_arch, boolean culture_pm, int count_shops, int year_repair, String name_city) {
    ...
    public String toString() {
        return this.count_shops + " " + this.year_repair + " " + this.name_city;
    }
